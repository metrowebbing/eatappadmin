...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    num dost = widget.post.get('dost');
    num minprice = widget.post.get('minprice');
    String deltime = widget.post.get('deltime');
    return Scaffold(
      appBar: AppBar(
        leading: InkWell(
              ...
              children: [
                InkWell(
                  onTap: () => showDialog<String>(
                    ...
                    builder: (BuildContext context) => AlertDialog(
                      content: Text(
                          'Стоимость доствки от $dostруб., если сумма заказа меньше чем $minpriceруб.\nБесплатная доставка от $minpriceруб.\nПримерное время доставки - $deltime мин.'),
                      actions: <Widget>[
                        OutlinedButton(
                    ...
                    child: RichText(
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                              text: ' от $dost\u{20bd}~$deltime мин.',
                              style: TextStyle(
                ...
                InkWell(
                  onTap: () => showDialog<String>(
                    ...
                    builder: (BuildContext context) => AlertDialog(
                      content: Text(
                          'Стоимость заказа для бесплатной доставки - $minpriceруб.'),
                      actions: <Widget>[
                        OutlinedButton(
                          onPressed: () => Navigator.pop(context, 'OK'),
                          child: Text('Понятно'),
                  ...
                  child: Container(
                    ...
                    child: RichText(
                      text: TextSpan(children: [
                        ...
                        TextSpan(
                            text: ' от ' + minprice.toString() + ' \u{20bd}',
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.black87)),
                      ]),
                ...
                return Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      bool stoplist =
                          snapshot.data!.docs[index].get('stoplist');

                      String col = snapshot.data!.docs[index].get('col');
